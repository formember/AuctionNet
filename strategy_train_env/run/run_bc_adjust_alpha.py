...
def train_model():
    ...
    train_data_path = "./data/adjust_best_alpha/training_data_v2.csv"
    ...
    step_num = 60000
    model = BC(dim_obs=state_dim,total_training_steps=step_num)
    ...
    model.save_jit("saved_model/BC_adjust_alpha_v2")
...
def load_model():
    ...
    """
    model = BC(dim_obs=16)
    model.load_net("saved_model/BC_adjust_alpha_v2")
