    ...
    for advertiserNumber in range(0, 48):
        ...
        for repeat in range(10):
            ...
            for timeStepIndex in range(0, 48):
                ...
                current_pValues_mean = np.mean(now_pValues)
                ...
                state = np.array([
                    (48 - timeStepIndex) / 48.0, remaining_budget / budget, historical_bid_mean, last_three_bid_mean,
                ...
                adjust_alpha = best_alpha + cpa * (np.random.rand() - 0.5)
...
def main():
    ...
    training_data.to_csv("./data/adjust_best_alpha/training_data_dt_origin_feature.csv", index=False)
