...
def train_model():
    ...
    train_data_path = "./data/adjust_best_alpha/training_data_feature_cpa_coef.csv"
    ...
    save_normalize_dict(normalize_dic, "saved_model/BC_adjust_alpha_feature_coef")
    ...
    model = BC(dim_obs=state_dim,hidden_size=256,isTanh=True)
    step_num = 10000
    batch_size = 100
    ...
    model.save_jit("saved_model/BC_adjust_alpha_feature_coef")
...
def load_model():
    ...
    """
    model = BC(dim_obs=16)
    model.load_net("saved_model/BC_adjust_alpha_feature_coef")
